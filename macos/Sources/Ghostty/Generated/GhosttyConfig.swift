...
enum FontShapingBreak: String {
    case word, anywhere
}

/// Background image positioning
enum BackgroundImagePosition: String {
    case center
...
enum BackgroundImageFit: String {
    case fill, contain, cover, stretch
}

/// Clipboard access control
enum ClipboardAccess: String {
    case allow, deny, ask
}
...
/// GTK tabs location
enum GtkTabsLocation: String {
    case top, bottom, left, right
}

/// GTK single instance mode
enum GtkSingleInstance: String {
    case desktop, session, never
}

/// FreeType load flags
struct FreetypeLoadFlags: OptionSet {
    let rawValue: Int
    init(rawValue: Int) { self.rawValue = rawValue }

    static let defaultFlags: FreetypeLoadFlags = []
    static let noHinting = FreetypeLoadFlags(rawValue: 1 << 0)
    static let forceAutoHint = FreetypeLoadFlags(rawValue: 1 << 1)
    static let noBitmap = FreetypeLoadFlags(rawValue: 1 << 2)
}
