    ...
    final class Surface: Sendable {
        ...
        deinit {
            guard !Thread.isMainThread else {
                ...
                //
                // OS runtime seems to schedule `appTick` and `ghostty_app_free` differently for pre-26, 26 and 27.
                // On macOS 26.x, `ghostty_app_free` happens after `App.scrollbar(_:target:v:)`,
